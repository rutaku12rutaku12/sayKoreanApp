...
public class AdminTestService {
    ...
    // ❌ [*] 일일시험 : 매일 다른 문제로 시험 생성 (난수화) 클라이언트에서 처리
    // 배운 예문 중 매일 랜덤하게 3개 선택
    // 그림/음성/주관식 각 1문제씩

    // ❌ [*] 무한모드 : 배운 내용 중 틀릴 때까지 특정 주제의 모든 예문을 난수화하여 제공 / 빈 시험만 제공 , 컨트롤러에서 처리
    // 프론트엔드에서 틀리면 종료

    // ❌ [*] 하드모드 : 모든 예문 중 틀릴 때까지 , 모든 주제의 예문을 난수화하여 제공 / 빈 시험만 제공 , 컨트롤러에서 처리
